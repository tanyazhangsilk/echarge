...
class Charger(Base, BaseModel):
    ...
    def __repr__(self) -> str:
        return f"<Charger(id={self.id}, sn_code='{self.sn_code}')>"


# ==============================================================================
# 领域: 业务与计费 (Business & Pricing)
# ==============================================================================

class PriceTemplate(Base, BaseModel):
    """
    计费模板模型 (busi_price_templates)
    """
    ...
    def __repr__(self) -> str:
        return f"<PriceTemplate(id={self.id}, name='{self.name}')>"
...
class Coupon(Base, BaseModel):
    ...
    def __repr__(self) -> str:
        return f"<Coupon(id={self.id}, type='{self.type}')>"


class UserCoupon(Base, BaseModel):
    """
    用户领券记录模型 (mkt_user_coupons)
    """
