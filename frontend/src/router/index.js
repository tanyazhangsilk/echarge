  ...
  { path: '/', redirect: () => resolveRoleDefaultRoute(getStoredRole()) },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { role: ROLES.ADMIN, title: '电站审核', section: '审核中心', description: '审核电站申请资料、建设信息与上架状态', keepAlive: true },
      },
      {
        path: 'orders',
        name: 'AdminOrders',
      ...
      { path: 'settings/params', redirect: '/admin/settings/params/basic' },
      {
        ...
        meta: { role: ROLES.ADMIN, title: '系统参数配置', section: '系统配置', description: '维护平台基础、计费、清分与通知参数', settingsSection: 'basic' },
      },
      {
        path: 'settings/params/billing',
        name: 'AdminSettingsParamsBilling',
        component: () => import('../views/admin/SystemParams.vue'),
        meta: { role: ROLES.ADMIN, title: '系统参数配置', section: '系统配置', description: '维护平台基础、计费、清分与通知参数', settingsSection: 'billing' },
      },
      {
        path: 'settings/params/settlement',
        name: 'AdminSettingsParamsSettlement',
        component: () => import('../views/admin/SystemParams.vue'),
        meta: { role: ROLES.ADMIN, title: '系统参数配置', section: '系统配置', description: '维护平台基础、计费、清分与通知参数', settingsSection: 'settlement' },
      },
      {
        path: 'settings/params/notification',
        name: 'AdminSettingsParamsNotification',
        component: () => import('../views/admin/SystemParams.vue'),
        meta: { role: ROLES.ADMIN, title: '系统参数配置', section: '系统配置', description: '维护平台基础、计费、清分与通知参数', settingsSection: 'notification' },
      },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { role: ROLES.OPERATOR, title: '电站管理', section: '资产管理', description: '维护电站资料、审核状态与运营信息', keepAlive: true },
      },
      {
        path: 'stations/chargers',
        name: 'OperatorStationsChargers',
        component: () => import('../views/stations/PileManagement.vue'),
        meta: { role: ROLES.OPERATOR, title: '电桩管理', section: '资产管理', description: '维护电桩编号、功率、状态与所属电站' },
      },
      {
        path: 'billing',
      ...
      { path: 'orders', redirect: '/operator/orders/history' },
      {
        ...
        component: () => import('../views/orders/HistoryOrders.vue'),
        meta: { role: ROLES.OPERATOR, title: '历史订单', section: '订单管理', description: '查看已完成订单与结算信息', keepAlive: true },
      },
      {
      ...
      },
      {
        ...
        component: () => import('../views/orders/AbnormalOrders.vue'),
        meta: { role: ROLES.OPERATOR, title: '异常订单', section: '订单管理', description: '查看异常订单与复核结果', keepAlive: true },
      },
      {
        path: 'orders/detail/:id',
      ...
      },
      {
        ...
        component: () => import('../views/finance/InvoiceManagement.vue'),
        meta: { role: ROLES.OPERATOR, title: '发票管理', section: '财务管理', description: '处理发票申请与开票记录' },
      },
      {
        path: 'customers',
